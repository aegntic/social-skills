  ...
  return (
    <GrowthGuideLayout>
      <div className="space-y-8">
        <div>
          <div className="text-xs font-bold uppercase tracking-wider text-acc-cyan mb-1">Section 6 of 7</div>
        ...
        <div className="plush-card p-6 space-y-4">
          ...
          <div className="space-y-3">
            {[
              ...
              <div key={i} className="p-4 rounded-xl" style={{ background: "rgb(var(--c-fill-1))" }}>
