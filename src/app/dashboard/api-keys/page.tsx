    ...
    <DashboardShell title="AI Agents, MCP & API Keys">
      <div className="max-w-4xl space-y-8">
        ...
        <div className="plush-card p-6 border-l-4 border-l-amber-400 flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
          <div>
            <div className="text-xs font-black uppercase tracking-widest text-acc-amber mb-1">API Credit Balance</div>
        ...
        <div className="plush-card p-6 space-y-6">
          ...
          <div className="p-3.5 rounded-xl bg-slate-900 border border-slate-700 font-mono text-xs text-acc-amber flex justify-between items-center">
            <span>{apiKey}</span>
        ...
        <div className="plush-card p-6 space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="p-4 rounded-2xl bg-slate-900 border border-slate-800 space-y-3">
              <div className="text-xs font-black text-acc-amber">STARTER PACK</div>
            ...
            <div className="p-4 rounded-2xl bg-slate-900 border border-slate-800 space-y-3">
              <div className="text-xs font-black text-acc-purple">AGENCY PACK</div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="plush-card p-6 space-y-4">
            ...
            <pre className="p-4 rounded-xl bg-slate-900 text-acc-cyan font-mono text-[11px] overflow-x-auto border border-slate-800">
{`{
  "mcpServers": {
    "socialskills": {
      "command": "npx",
        ...
        "SOCIALSKILLS_API_KEY": "${apiKey}"
          ...
          <div className="plush-card p-6 space-y-4">
            <div className="flex items-center justify-between">
              ...
              <span className="text-[10px] font-extrabold bg-amber-400/20 text-acc-amber px-2 py-0.5 rounded-full border border-amber-400/30">CLI Ready</span>
            </div>
            <div className="text-xs text-slate-400 font-medium">Install official skill for Antigravity, AGY, or OpenClaw runner.</div>
            <pre className="p-4 rounded-xl bg-slate-900 text-acc-amber font-mono text-[11px] overflow-x-auto border border-slate-800">
